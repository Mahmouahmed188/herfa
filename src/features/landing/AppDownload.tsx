        ...
        <section className="relative flex flex-col bg-background-light dark:bg-background-dark py-20">
            <div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center">
                <div className="layout-content-container flex flex-col max-w-[1200px] flex-1 rounded-[3rem] overflow-hidden relative">
                    <div className="absolute inset-0 bg-surface-dark bg-cover bg-center" style={{ backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuB1zJg6FK4tAsCnHQlxKT1HPVcLb-C5-Iv315hpF9aizXJsMY_JWFk07-Fr0TFWJTp5H9mGL3lYQY8IdbfbRvyzYOBYFQVhecdgnjqLbMF2rPLFtB5AX4x6e-rp5CD133EhkY7ivRDtJJJT6AKasFWJ8P2_dKEzWbDuO3NseaI9-plWivtuOdOsgDJjhmMN3uBFQ6uY2PKvF3ytXz2PBr0gE7sKutQWrJmt3r0a8G_yFCP8_myRo8Fi-NLHG_U7995OhC5UlTj7UnY")', opacity: 0.2 }}></div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-10 md:p-16 gap-10">
                        <div className="flex flex-col gap-6 max-w-[500px] text-center md:text-left">
                            <h2 className="text-white text-3xl md:text-5xl font-black leading-tight">Get the job done,<br /><span className="text-primary">Anywhere.</span></h2>
                            <p className="text-gray-300 text-lg">Download the Herfa app to manage projects, find technicians, and diagnose issues on the go.</p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                                <button className="flex items-center gap-3 bg-white text-black px-6 py-3 rounded-xl hover:bg-gray-100 transition-colors w-fit mx-auto sm:mx-0">
                                    <div className="flex items-center justify-center">
                                        {/* Google Play Icon Replacement */}
                                        <Smartphone className="w-8 h-8" />
                                    </div>
                                    <div className="flex flex-col items-start leading-none">
                                        <span className="text-[10px] font-bold uppercase tracking-wider">Get it on</span>
                                ...
                                <button className="flex items-center gap-3 bg-transparent border border-white/30 text-white px-6 py-3 rounded-xl hover:bg-white/10 transition-colors w-fit mx-auto sm:mx-0">
                                    <div className="flex items-center justify-center">
                                        {/* App Store Icon Replacement */}
                                        <Tablet className="w-8 h-8" />
                                    </div>
                                    <div className="flex flex-col items-start leading-none">
                                        <span className="text-[10px] font-bold uppercase tracking-wider">Download on the</span>
