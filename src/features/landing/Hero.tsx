                        ...
                        <div className="flex flex-col-reverse gap-6 px-4 py-10 @[864px]:flex-row @[864px]:items-center">
                            <div className="flex flex-col gap-8 @[480px]:min-w-[400px] flex-1">
                                <div className="flex flex-col gap-4 text-left">
                                    <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 dark:border-surface-border bg-white dark:bg-surface-dark px-3 py-1 w-fit">
                                        ...
                                        <span className="text-xs font-bold text-slate-600 dark:text-gray-300">Certified Professionals</span>
                                    </div>
                                    <h1 className="text-slate-900 dark:text-white text-4xl font-extrabold leading-tight tracking-[-0.033em] @[480px]:text-6xl">
                                        Build Better with <span className="text-primary">Expert Technicians</span>
                                    </h1>
                                    <h2 className="text-slate-600 dark:text-gray-300 text-lg font-medium leading-relaxed max-w-[600px]">
                                        Connect with top-rated professionals and use AI to diagnose construction issues instantly. Trusted by thousands of engineers and homeowners.
                                    </h2>
                                </div>
                                <div className="flex flex-wrap gap-4">
                                    <button className="flex min-w-[160px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-primary text-background-dark text-base font-bold leading-normal tracking-[0.015em] hover:brightness-110 transition-all">
                                        <span className="truncate">Find a Technician</span>
                                    </button>
                                    <button className="flex min-w-[160px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-6 bg-gray-200 dark:bg-surface-border text-slate-900 dark:text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-gray-300 dark:hover:bg-[#3d4b39] transition-all">
                                ...
                                <div className="flex items-center gap-4 pt-4">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs font-medium text-slate-500 dark:text-gray-400">Trusted by professionals</span>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl bg-gray-100 dark:bg-surface-dark flex-1 relative group">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-background-light/90 dark:bg-surface-dark/90 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center gap-4 shadow-lg">
                                    ...
                                    <div>
                                        <p className="text-slate-900 dark:text-white font-bold text-sm">Site Inspection Complete</p>
                                        <p className="text-slate-500 dark:text-gray-400 text-xs">AI Report Generated • 2 mins ago</p>
                                    </div>
