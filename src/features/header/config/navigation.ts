...
const clientItems: NavigationItem[] = [
  { id: 'myBookings', labelKey: 'Header.nav.myBookings', href: '/client/my-bookings', roles: ['CUSTOMER'], order: 10 },
  { id: 'dashboard', labelKey: 'Header.nav.dashboard', href: '/client/dashboard', roles: ['CUSTOMER'], order: 20 },
  { id: 'profile', labelKey: 'Header.nav.profile', href: '/client/profile', roles: ['CUSTOMER'], order: 30 },
];

const technicianItems: NavigationItem[] = [
  { id: 'myJobs', labelKey: 'Header.nav.myJobs', href: '/technician/my-jobs', roles: ['PROVIDER'], order: 10 },
  { id: 'earnings', labelKey: 'Header.nav.earnings', href: '/technician/earnings', roles: ['PROVIDER'], order: 20 },
  { id: 'schedule', labelKey: 'Header.nav.schedule', href: '/technician/schedule', roles: ['PROVIDER'], order: 30 },
  { id: 'dashboard', labelKey: 'Header.nav.dashboard', href: '/technician/dashboard', roles: ['PROVIDER'], order: 40 },
];
