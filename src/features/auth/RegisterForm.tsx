        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span
                className={`text-sm font-semibold ${selectedRole === 'customer' ? 'text-primary' : 'text-slate-600 dark:text-gray-400'}`}
              >
                Customer
              </span>
            ...
            >
              ...
              <span
                className={`text-sm font-semibold ${selectedRole === 'provider' ? 'text-primary' : 'text-slate-600 dark:text-gray-400'}`}
              >
                Provider
              </span>
