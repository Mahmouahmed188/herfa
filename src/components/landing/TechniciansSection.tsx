...
{/* Re-implementing Technicians based on the rich HTML design */ }
                ...
                <div className="layout-content-container flex flex-col max-w-[1200px] flex-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
                        {technicians.map((tech, i) => (
                            <div key={i} className="group flex flex-col gap-4 rounded-3xl border border-gray-200 dark:border-surface-border bg-white dark:bg-surface-dark p-6 transition-all hover:shadow-xl hover:-translate-y-1 text-start">
