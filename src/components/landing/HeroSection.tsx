              ...
              <div className="flex flex-col gap-8 @[480px]:min-w-[400px] flex-1">
                ...
                <div className="flex items-center gap-4 pt-4">
                  <div className="flex -space-x-4">
                    <div
                      className="size-10 rounded-full border-2 border-background-light dark:border-background-dark bg-cover bg-center"
                      style={{
                        backgroundImage:
                          'url("https://lh3.googleusercontent.com/aida-public/AB6AXuC-tlB6j2X66sq-VfjjyU-NfL7utkW4flZRUCpPE4qWqU24PoKCjUfAEtYO-wlVSikcDPOzMdQjcn7OjM3BWMOefyw3AG0wvq0u26tN0TYXbB7tjYxGA1e-RWyLSK_H09p7uOjqutXAeBBGqUAZtjbR6I2qsQMkkhOtL1Am-sisw27_dzf1r1AFoev53FxzJ906XLjjkoh9kH5mOutxOUfwZ6pe18BKBuxxt08A5kT4_TFNTgwDMRi5iFcDIG3WNTbF3pcz9hkzEtc")',
                      }}
                    ></div>
                    <div
                      className="size-10 rounded-full border-2 border-background-light dark:border-background-dark bg-cover bg-center"
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBTMqH2yOSqhaLyKRuu9iowORlsPx37mp0iWsGnONR4O2r5niKl_ElV5d4WtxRMtIAdPjj4cXUKfJOvo47OZTl99NtIKoS61halMSIpEOaXlpEpPTSZq21muRHaDsshpgehs2p57D4V4GAj01wF_KrCvKN-WmqQ2JLK_xhBZJygZsXM_wgdpn3BipHK_ym6UOX6JgqKaRpY8_raBPbc2ux_To1XeVXw5_5dTNSlInMmD1kvsQhAmn4S4mb3iEMRRFhTgvtSVPB342k")',
                      }}
                    ></div>
